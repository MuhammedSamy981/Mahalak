...
public class UsersManager : IUsersManager
{
    ...
    public void EditStatus(Guid id, bool status)
    {
        var user = unitOfWork.UsersRepository.GetById(id);
        if (user != null)
        {
    ...
    public bool CheckViolationsCount()
    {
      ...
      { 
        EditStatus(user.ID,false);
        }
        else
        {
           EditStatus(user.ID,true); 
        }
        }
      }
      return true;
    ...
    public void EditAddingShops(Guid id,int shopsCount, int period)
    {
        var user = unitOfWork.UsersRepository.GetById(id);
        if (user != null)
        {
