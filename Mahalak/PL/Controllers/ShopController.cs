...
public class ShopController : Controller
{
    ...
    {
        usersManager.CheckViolationsCount();
        ...
        var shops = shopsManager.GetAllPaginatedWithFilter(2, id!.Value, categoryID, countryID, cityID, areaID);
    ...
    public IActionResult RemoveDistinctive(int id)
    {
        shopsManager.EditDistinctive(id, false, 0);
        return RedirectToAction("index", "user");
    }
