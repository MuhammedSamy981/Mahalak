...
public class UserController : Controller
{
  ...
  [Route("admin")]
    [Route("admin/{table}/{id}")]
  public IActionResult Index(GetAllAdminPermissiosDTO adminPermissios,
    Microsoft.AspNetCore.Http.IFormCollection formcollection)
  {
    ...
    if (adminPermissios.DistinctivePeriod != null && adminPermissios.DistinctivePeriod != "0")
    {
      ...
      shopsManager.EditDistinctive(shopId, true, period);
    }
    else
    ...
    && adminPermissios.AddingShopsPeriod != null && adminPermissios.AddingShopsPeriod != 0)
    {
      ...
      usersManager.EditAddingShops(userId, shopsCount, period);
    }
  ...
  {
    usersManager.EditStatus(id, true);
    return RedirectToAction("Index");
  }
  ...
  {
    usersManager.EditStatus(id, false);
    return RedirectToAction("Index");
  }
  ...
  public IActionResult RemoveAddingShops(Guid id)
  {
    usersManager.EditAddingShops(id, 2, 0);
    return RedirectToAction("index");
  }
